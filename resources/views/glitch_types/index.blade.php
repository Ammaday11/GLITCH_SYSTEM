                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h3 class="mb-2">Glitch Types</h3>
                                    <p class="pageheader-text"></p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Glitch Types</a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{route('glitch_type.create')}}" class="btn btn-info">New Glitch Type</a>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                                ...
                                                <tbody>
                                                    @foreach ($glitch_types as $glitch_type)
                                                        <tr>
                                                            <td>{{ $glitch_type->id }}</td>
                                                            <td>{{ $glitch_type->type }}</td>
                                                            <td>
                                                                @can('manage_glitch_types')
                                                                <a href="{{route('glitch_type.delete', ['id' => $glitch_type->id])}}" class="btn  btn-danger btn-sm m-r-10 fas fa-trash"></a>
