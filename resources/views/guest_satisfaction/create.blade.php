            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2">Create Guest Satisfaction</h3>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin: auto">
                        <div class="card">
                            <h5 class="card-header">Create New Guest Satisfaction</h5>
                            <div class="card-body">
                                <form action="{{ route('guest_satisfaction.store') }}"  data-parsley-validate="" method='POST' enctype="multipart/form-data">
                                    @include('include.messages')

                                    @csrf
                                    <div class="form-group">
                                        <label  for="guest_satisfaction">Type</label>
                                        <input type="text" name="guest_satisfaction"  placeholder="Guest Satisfaction" class="form-control" required>
                                    </div>
