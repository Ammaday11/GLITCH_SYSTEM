                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Staff</a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{route('staff.create')}}" class="btn btn-info">New Staff</a>
                                    </div>
                                    <div class="card-body">
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="input-group-append be-addon">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            @can('manage_staff')
                                                                            <a href="{{route('staff.delete', ['id' => $staff->id])}}" class="dropdown-item">Delete</a>
                                                                            @endcan('manage_staff')
                                                                        </div>
                                                                    </div>
                                                                </div>
