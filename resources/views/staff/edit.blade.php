            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin: auto">
                        <div class="card">
                            <h5 class="card-header">{{$staff->name}} - Edit</h5>
                            <div class="card-body">
                                <form action="{{route('staff.update', ['id' => $staff->id])}}"  data-parsley-validate="" method='POST' enctype="multipart/form-data">
